...
/**
 * کار شما، هماهنگ – گفتگوی ایده‌پردازی تیمی
 * رابط کاربری چت برای بحث درباره اپ آموزش آنلاین با هوش مصنوعی
...
const YourWorkInSync: React.FC<YourWorkInSyncProps> = ({
  ...
  return (
    <div
      ...
      role="img"
      aria-label="گفتگوی تیمی درباره ایده اپ آموزش آنلاین با هوش مصنوعی"
    >
