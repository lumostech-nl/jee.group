...
const SmartSimpleBrilliant: React.FC<SmartSimpleBrilliantProps> = ({
  ...
  return (
    <div
      ...
      role="img"
      aria-label="تقویم اتوماسیون صنعتی - برنامه‌ریزی فرآیندهای تولید"
    >
      <div
        style={{
          position: "relative",
            ...
            >
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Vazir, sans-serif", fontWeight: 500, fontSize: "9px", color: "#92400E" }}
                    >
                      ۱۴:۰۰
                    </span>
                  ...
                  <div style={{ fontFamily: "Vazir, sans-serif", fontWeight: 600, fontSize: "9px", color: "#92400E" }}>
                    بازرسی سیستم اتوماسیون
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Vazir, sans-serif", fontWeight: 500, fontSize: "9px", color: "#0C4A6E" }}
                    >
                      ۱۴:۰۰
                    </span>
                  ...
                  <div style={{ fontFamily: "Vazir, sans-serif", fontWeight: 600, fontSize: "9px", color: "#0C4A6E" }}>
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Vazir, sans-serif", fontWeight: 500, fontSize: "9px", color: "#064E3B" }}
                    >
                      ۹:۰۰
                    </span>
                  </div>
                  <div style={{ fontFamily: "Vazir, sans-serif", fontWeight: 600, fontSize: "9px", color: "#064E3B" }}>
                    آموزش PLC و HMI
                  </div>
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Vazir, sans-serif", fontWeight: 500, fontSize: "9px", color: "#581C87" }}
                    >
                      ۱۱:۰۰
                    </span>
                  ...
                  <div style={{ fontFamily: "Vazir, sans-serif", fontWeight: 600, fontSize: "9px", color: "#581C87" }}>
                    راه‌اندازی خط تولید
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  <div style={{ display: "flex", gap: "3px", alignItems: "center" }}>
                    <span
                      style={{ fontFamily: "Vazir, sans-serif", fontWeight: 500, fontSize: "9px", color: "#BE123C" }}
                    >
                      ۱۶:۰۰
                    </span>
                  ...
                  <div style={{ fontFamily: "Vazir, sans-serif", fontWeight: 600, fontSize: "9px", color: "#BE123C" }}>
                    ⚙️ تعمیر و نگهداری
                  </div>
                </div>
              </div>
