  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img
            src="companyLogos/karizor-logo.png"
            alt="Karizor"
            style={{
              width: "18px",
              height: "18px",
        ...
        >
          <img
            src="companyLogos/irancell-logo.svg"
            alt="Irancell"
            style={{
              width: "18px",
              height: "18px",
        ...
        >
          <img
            src="companyLogos/hamrahe-aval-old-logo.svg"
            alt="Hamrahe Aval"
            style={{
              width: "16px",
              height: "16px",
        ...
        >
          <img
            src="companyLogos/daneshgah-tehran-logo.svg"
            alt="Daneshgah Tehran"
            style={{
              width: "25px",
              height: "25px",
            }}
        ...
        >
          <img
            src="companyLogos/soroush-rasaneh-logo.png"
            alt="Soroush Resane"
            style={{
              width: "18px",
              height: "18px",
        ...
        >
          <img
            src="companyLogos/pasargad-epay.webp"
            alt="Pardakht Electronic Pasargad"
            style={{
              width: "18px",
              height: "18px",
            }}
        ...
        >
          <img
            src="companyLogos/bank-sepah-logo.svg"
            alt="Bank Sepah"
            style={{
              width: "16px",
              height: "16px",
