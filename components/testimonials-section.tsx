...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote: "در عرض چند هفته، سیستم اینترنت اشیا ما را کاملاً متحول کردند. کیفیت کار و سرعت پیاده‌سازی فوق‌العاده بود!",
      name: "احمد محمدی",
      company: "مدیرعامل، شرکت صنعتی پارس",
      image:
    ...
    {
      quote: "پلتفرم ابری شرکت ژی کاملاً کسب‌وکار ما را دگرگون کرد. اتوماسیون فرآیندها هفته‌ها وقت ما را صرفه‌جویی می‌کند.",
      name: "فاطمه احمدی",
      company: "مدیر عملیات، تک‌فلو",
      image:
    ...
    {
      quote: "سیستم مانیتورینگ صنعتی که طراحی کردند، دقت و کارایی تولید ما را به طور چشمگیری افزایش داد.",
      name: "علی رضایی",
      company: "مدیر فنی، نوآوران صنعت",
      image:
    ...
    <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
      ...
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center bg-background border border-b border-l-0 border-r-0 border-t-0">
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row-reverse">
            <img
            ...
            <div className="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-[#49423D] text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] font-sans h-[200px] md:h-[210px] overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight text-right"
                style={{
              ...
              <div
                className="self-stretch flex flex-col justify-start items-end gap-1 transition-all duration-700 ease-in-out"
                style={{
                  filter: isTransitioning ? "blur(4px)" : "blur(0px)",
                  transition: "filter 0.7s ease-in-out",
                }}
              >
                <div className="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.90)] text-lg font-medium leading-[26px] font-sans text-right">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.70)] text-lg font-medium leading-[26px] font-sans text-right">
