          ...
          <div className="w-full max-w-md mx-auto relative z-10">
            ...
            <Card className="bg-white shadow-[0px_0px_0px_0.9056603908538818px_rgba(0,0,0,0.08)] border-[rgba(55,50,47,0.06)] rounded-lg">
              <CardHeader className="text-center">
                <CardTitle className="text-[#37322F] text-xl font-semibold font-sans">ثبت‌نام</CardTitle>
                <CardDescription className="text-[#605A57] text-sm font-sans">
                  روش ثبت‌نام مورد نظر خود را انتخاب کنید
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <form onSubmit={handleEmailSignUp} className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <User className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#605A57]" size={20} />
                      <Input
                        id="name"
                        name="name"
                        type="text"
                  ...
                  >
                    {loading ? 'در حال ارسال...' : 'ارسال لینک ثبت‌نام'}
                  </Button>
                </form>
              </CardContent>
            </Card>
